...
public class MainWindow {
	...
	private void setupApp() {
		...
		logger.setLocation(frmGameEditor.getLocation().x,
				frmGameEditor.getLocation().y + frmGameEditor.getHeight());
	...
	private void initialize() {
		...
		paneCanvas.setBorder(new SoftBevelBorder(BevelBorder.LOWERED, null,
				null, null, null));
		...
		mntmExit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				frmGameEditor.dispatchEvent(new WindowEvent(frmGameEditor,
